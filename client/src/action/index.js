...
export const loginAC = (user,navigate)=>{
  return function(dispatch){
    axios.post('https://megamarket-w0p4.onrender.com/login',{user}).then(function (response) {
...
export const checkAuthAC = (navigate)=>{
  return function(dispatch){
    axios.get('https://megamarket-w0p4.onrender.com/user').then(function (response) {
...
export const signupAC = (user,navigate)=>{
  return function(dispatch){
    axios.post('https://megamarket-w0p4.onrender.com/signup',{user}).then(function (response) {
      if(response.data.status){
        dispatch({type:INIT_USER, payload: response.data.user})
        dispatch(initializeCartAC(response.data.user._id));
        navigate('/');
...
export const logoutAC = (navigate)=>{
  return function(dispatch){
    axios.get('https://megamarket-w0p4.onrender.com/logout').then(function (response) {
...
export const initializeProductsAC = () => {  //AC = Action Creator
    return function (dispatch) {
        axios.get("https://megamarket-w0p4.onrender.com/product").then(function (response) {
...
export const initializeCartAC = (userId) => {
    return function (dispatch) {
        axios.get('https://megamarket-w0p4.onrender.com/cart').then(function (response) {
...
export const changeCart = (dispatch, item) => {
    ...
    axios.post("https://megamarket-w0p4.onrender.com/cart", { item: item }).then(function (response) {
...
export const addAddressAC = (address) => {  //AC = Action Creator
    return function (dispatch) {
        axios.post('https://megamarket-w0p4.onrender.com/updateUserAddress', { address: address }).then(function (response) {
...
export const placeOrderAC = (order,navigate) => {  //AC = Action Creator
    return function (dispatch) {
        axios.post('https://megamarket-w0p4.onrender.com/order', { order: order }).then(function (response) {
            //console.log(response);
...
export const emptyCartAC = () => {  //AC = Action Creator
    return function (dispatch) {
        axios.post('https://megamarket-w0p4.onrender.com/emptyCart').then(function (response) {
            //console.log(response);
            dispatch({ type: CHANGED_ITEM_IN_CART, payload: response.data })
        })
            .catch(function (error) {
...
export const removeItemAC = (item) => {  //AC = Action Creator
    return function (dispatch) {
        axios.post('https://megamarket-w0p4.onrender.com/removeItem', { item: item }).then(function (response) {
            //console.log(response);
            dispatch({ type: CHANGED_ITEM_IN_CART, payload: response.data })
        })
            .catch(function (error) {
