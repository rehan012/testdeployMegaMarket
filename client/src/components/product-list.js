                ...
                <div id="products" className="row">
                    ...
                    {products.map(product => <div  key={product._id} className="col-xl-3 col-lg-4 col-md-6 position-relative">
                        <div className="card product-item">
                            ...
                            <Link to={`/product/${product._id}`}><img src={`../../public/Images/${product.image}.jpg`} className="card-img-top" alt="..." data-bs-toggle="tooltip" data-bs-placement="top" title="Click to See Product Details" />
                            </Link>
